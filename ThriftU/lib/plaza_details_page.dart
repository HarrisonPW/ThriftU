...
class PlazaDetailsPage extends StatefulWidget {
  final int postId;
  final String token;

  const PlazaDetailsPage({Key? key, required this.postId, required this.token}) : super(key: key);

  @override
  _ItemDetailsPageState createState() => _ItemDetailsPageState();
}

class _ItemDetailsPageState extends State<PlazaDetailsPage> {
